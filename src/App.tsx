...
type Category = 'wins' | 'challenges' | 'misses' | 'insights' | 'priorities';
...
const CATEGORY_LABELS: Record<Category, string> = {
  ...
  misses: 'Misses / Gaps',
  insights: 'Insights',
  priorities: 'Priorities for next q',
};

const CATEGORY_COLORS: Record<Category, string> = {
  wins: 'bg-green-50/30',
  challenges: 'bg-orange-50/30',
  misses: 'bg-red-50/30',
  insights: 'bg-blue-50/30',
  priorities: 'bg-purple-50/30',
};
      ...
      <main className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <SignedIn>
          {loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-4 lg:gap-6">
